...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user.product.create', ['application' => $application, 'shop' => $shop, 'products' => $products, 'categories' => $categories, 'aromas' => $aromas, 'types' => $types, 'compositions' => $compositions, 'wickTypes' => $wTypes, 'diffuserTypes' => $diffuserTypes, 'diffuserPlacements' => $diffuserPlacements, 'flavoringTypes' => $flavoringTypes, 'mCountries' => $mCountries, 'colorNames' => $colorNames]);
    }
...
//        dd($request->all());
        ...
        if ($request->aroma) {
            $product->aromas()->attach($request->aroma);
        }
    ...
    public function update(ProductRequest $request, Product $product)
    {
        ...
        $dataCharacteristics = $request->only(['country_of_manufacture', 'compound', 'material', 'height', 'volume', 'burning_time', 'wick_type', 'type', 'weight', 'color']);
